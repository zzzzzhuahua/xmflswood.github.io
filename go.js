  ...
  function go() {
    typish('#typer')
      ...
      .type('今天张先生教你写代码呀', '<span class="note">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .wait(10)
      ...
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'2018-02-14'", '<span class="green">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .type('}', '<span class="gray">')
      .type('0', '<br>')
      ...
      // width
      .type('0000', '<span class="blank">')
      .type('小仙女最近喜欢的电视剧', '<span class="gray">')
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'谈判官'", '<span class="green">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      // margin
      .type('0000', '<span class="blank">')
      .type('大坏蛋性格', '<span class="gray">')
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'蠢死了啦你'", '<span class="green">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      // top
      .type('0000', '<span class="blank">')
      .type('小仙女性格', '<span class="gray">')
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'一个字：好'", '<span class="green">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      // duration
      .type('0000', '<span class="blank">')
      .type('小仙女喜欢的东西', '<span class="gray">')
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'大坏蛋也都喜欢，小仙女是他的梦想'", '<span class="green">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .type('}', '<span class="gray">')
      .type('0', '<br>')
